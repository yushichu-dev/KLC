...
> **注**: v1.4.6-β 中，整数默认为 `i64`，浮点默认为 `f64`。`i8`/`i16`/`i32`/`u*`/`f32` 关键字已保留但当前仅支持 `i64` 和 `f64`。
=======
...
v1.4.6-β 解析器可识别 `own`、`borrow`、`borrow mut` 关键字，但当前版本**不做所有权检查**，仅作为语法占位保留：
