...
// ═══════════════════════════════════════════════════════
// v1.4.3: 新增 stdlib 函数名快速分类 (math/string/array/util)
// ═══════════════════════════════════════════════════════

/// 新增 stdlib 函数名集合 — v1.4.3 增强版
...
impl VM {
    ...
    fn handle_call(&mut self, name: &str, arg_count: usize) -> Result<(), String> {
        ...
        // ═══════════════════════════════════════════════════════
        // v1.4.3: assert 断言 (特殊处理: 失败时返回 Err 终止执行)
        // ═══════════════════════════════════════════════════════
        if name == "assert" {
        ...
        // ═══════════════════════════════════════════════════════
        // v1.4.3: 新增 stdlib 模块统一分发 (math/string/array/util)
        // ═══════════════════════════════════════════════════════
